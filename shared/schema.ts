...
export const RECOMMENDED_KEYWORDS = [
  { label: "Travel creators", keyword: "travel creator adventure trips" },
  { label: "Hiking & outdoors", keyword: "hiking outdoor adventure backpacking" },
  { label: "Yoga & wellness", keyword: "yoga wellness retreat mindfulness" },
  { label: "Fitness coaches", keyword: "fitness coach training community workout" },
  { label: "Photography", keyword: "photography travel workshop photo tours" },
  { label: "Women's community", keyword: "women community sisterhood empowerment" },
  { label: "Run clubs", keyword: "running club marathon trail running" },
  { label: "Cycling", keyword: "cycling bike touring gravel adventure" },
  { label: "Food & wine", keyword: "food wine culinary travel tasting" },
  { label: "Surf & water sports", keyword: "surf diving snorkel water sports" },
  { label: "Digital nomads", keyword: "digital nomad remote work travel" },
  { label: "Spiritual leaders", keyword: "spiritual retreat pilgrimage faith ministry" },
  { label: "Art & creativity", keyword: "art creative workshop painting retreat" },
  { label: "Book clubs", keyword: "book club reading literary community" },
  { label: "Solo travelers", keyword: "solo travel group trips adventure" },
  { label: "Climbing & mountaineering", keyword: "climbing mountaineering bouldering alpine" },
  { label: "Camping & van life", keyword: "camping van life overlanding road trip" },
  { label: "Nature & wildlife", keyword: "nature wildlife safari birdwatching conservation" },
] as const;
