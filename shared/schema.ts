...
export const RECOMMENDED_KEYWORDS = [
  { label: "Church groups", keyword: "church community group ministry" },
  { label: "Run clubs", keyword: "run club running group" },
  { label: "Hiking clubs", keyword: "hiking club outdoor adventure group" },
  { label: "Social clubs", keyword: "social club young professionals meetup" },
  { label: "Book clubs", keyword: "book club reading group community" },
  { label: "Alumni groups", keyword: "alumni chapter association network" },
  { label: "Fitness communities", keyword: "CrossFit yoga fitness community class" },
  { label: "Professional networks", keyword: "professional association networking organization" },
  { label: "Women's groups", keyword: "women's group community sisterhood network" },
  { label: "Volunteer orgs", keyword: "nonprofit volunteer community service organization" },
  { label: "Cycling clubs", keyword: "cycling club bike riding group" },
  { label: "Adventure clubs", keyword: "adventure club outdoor recreation group" },
  { label: "Photography groups", keyword: "photography club camera group workshop" },
  { label: "Wine & food clubs", keyword: "wine club food enthusiasts tasting group" },
  { label: "Meetup organizers", keyword: "meetup organizer community events host" },
  { label: "Coworking spaces", keyword: "coworking community remote workers space" },
  { label: "Dance communities", keyword: "dance class community salsa swing studio" },
  { label: "Wellness groups", keyword: "wellness meditation mindfulness community" },
] as const;
